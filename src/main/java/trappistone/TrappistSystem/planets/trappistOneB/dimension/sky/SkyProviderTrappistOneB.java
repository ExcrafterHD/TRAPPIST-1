package trappistone.TrappistSystem.planets.trappistOneB.dimension.sky;
...
public class SkyProviderTrappistOneB extends IRenderHandler
{
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc)
    {
        ...
        // Render sun
        f10 = 15.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderTrappistOneB.sunTexture);
