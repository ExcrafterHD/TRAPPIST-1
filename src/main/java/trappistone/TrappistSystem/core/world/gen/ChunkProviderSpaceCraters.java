...
public abstract class ChunkProviderSpaceCraters implements IChunkProvider
{
    ...
    protected BiomeGenBase[] biomesForGeneration = this.getBiomesForGeneration();
    ...
    public void generateTerrain(int chunkX, int chunkZ, Block[] idArray, byte[] metaArray)
    {
        ...
        for (int x = 0; x < ChunkProviderSpaceCraters.CHUNK_SIZE_X; x++)
        {
            for (int z = 0; z < ChunkProviderSpaceCraters.CHUNK_SIZE_Z; z++)
            {
                ...
                final double featureFilter = this.noiseGen5.getNoise(chunkX * 16 + x, chunkZ * 16 + z) * ChunkProviderSpaceCraters.MAIN_FEATURE_FILTER_MOD;
                final double largeFilter = this.noiseGen6.getNoise(chunkX * 16 + x, chunkZ * 16 + z) * ChunkProviderSpaceCraters.LARGE_FEATURE_FILTER_MOD;
                final double smallFilter = this.noiseGen7.getNoise(chunkX * 16 + x, chunkZ * 16 + z) * ChunkProviderSpaceCraters.SMALL_FEATURE_FILTER_MOD - 0.5;
                ...
                TPBiomeGenBase biome = (TPBiomeGenBase) this.worldObj.getBiomeGenForCoords(x + chunkX * 16, z + chunkZ * 16);
               
                for (int y = 0; y < ChunkProviderSpaceCraters.CHUNK_SIZE_Y; y++)
                {
    ...
    public void replaceBlocksForBiome(int par1, int par2, Block[] arrayOfIDs, byte[] arrayOfMeta, BiomeGenBase[] par4ArrayOfBiomeGenBase)
    {
        ...
        for (int var8 = 0; var8 < 16; ++var8)
        {
            for (int var9 = 0; var9 < 16; ++var9)
            {
                ...
                for (int var16 = ChunkProviderSpaceCraters.CHUNK_SIZE_Y - 1; var16 >= 0; --var16)
                {
