...
{	
	...
	public static List<BiomeGenBase> biome = new ArrayList();
	public static List<Block> block = new ArrayList();
	public static List<Byte> meta = new ArrayList();
	
	public static List<Block> block2 = new ArrayList();
	public static List<Byte> meta2 = new ArrayList();
	...
	public void replaceBlocksForBiome(int par1, int par2, Block[] arrayOfIDs, byte[] arrayOfMeta, BiomeGenBase[] par4ArrayOfBiomeGenBase)
    {
        ...
        for (int var8 = 0; var8 < 16; ++var8)
        {
            for (int var9 = 0; var9 < 16; ++var9)
            {
            	...
            	TPBiomeGenBase biomegenbase = (TPBiomeGenBase) par4ArrayOfBiomeGenBase[var8 + var9 * 16];
            
                final int var12 = (int) (this.noiseGen8.getNoise(par1 * 16 + var8, par2 * 16 + var9) / 3.0D + 3.0D + this.rand.nextDouble() * 0.25D);
                int var13 = -1;
               /* 
               ...
               */
                ...
                Block var15;
                byte var15m;
                if(biome.size() != 0 && par4ArrayOfBiomeGenBase[var8 + var9 * 16] == this.myBiomeCache.getBiomeGenAt(var8, var9))
                {
                	var14 = block.get(biome.indexOf(par4ArrayOfBiomeGenBase[var8 + var9 * 16]));
                	var14m = meta.get(biome.indexOf(par4ArrayOfBiomeGenBase[var8 + var9 * 16]));
                	var15 = block2.get(biome.indexOf(par4ArrayOfBiomeGenBase[var8 + var9 * 16]));
                	var15m = meta2.get(biome.indexOf(par4ArrayOfBiomeGenBase[var8 + var9 * 16]));
                }
                else
                {
                ...
                for (int var16 = 256 - 1; var16 >= 0; --var16)
                {
                    ...
                    else if(this.canGenerateIceBlock())
                    {
                    	if(var16 == 5 || var16 == 6 + this.rand.nextInt(3))
                    	{
                    		arrayOfIDs[index] =  Blocks.packed_ice;
                    	}
                    }
                    else
                    {
                            ...
                            if (var13 == -1)
                            {
                                ...
                                else if (var16 >= var5 - -16 && var16 <= var5 + 1)
                                {
                                	  if(biome.size() != 0 && par4ArrayOfBiomeGenBase[var8 + var9 * 16] == this.myBiomeCache.getBiomeGenAt(var8, var9))
                                      {
                                      	var14 = block.get(biome.indexOf(par4ArrayOfBiomeGenBase[var8 + var9 * 16]));
                                      	var14m = meta.get(biome.indexOf(par4ArrayOfBiomeGenBase[var8 + var9 * 16]));
                                      	var14 = block2.get(biome.indexOf(par4ArrayOfBiomeGenBase[var8 + var9 * 16]));
                                		var14m = meta2.get(biome.indexOf(par4ArrayOfBiomeGenBase[var8 + var9 * 16]));
                                      }
                                	  else
                                	  {
                                      	var14 = this.getGrassBlock().getBlock();
                        ...
                        else if (var18 == biomegenbase.stoneBlock && this.enableBiomeGenBaseBlock())
                        {
	...
	public static void setBlocks(BiomeGenBase biomes, Block blocks, byte metas, Block blocks2, byte metas2)
    {
    	biome.add(biomes);
    	block.add(blocks);
    	meta.add(metas);
